...
#include "libjodycode.h"
 ...
 #include <sys/ioctl.h>
 #define HDUPES_DEDUPE_SUPPORTED 1
 #define KERNEL_DEDUP_MAX_SIZE 16777216
 /* Error messages */
 static const char s_err_dedupe_notabug[] = "This is not a bug in hdupes; check your file stats/permissions.";
...
#ifndef HDUPES_DEDUPE_SUPPORTED

...
# This is a shell script that deletes match sets like hdupes -dN does, but
# excludes any file paths from deletion that match any of the grep regex
# patterns passed to the script. Use it like this:
#
# hdupes whatever | ./delete_but_exclude.sh regex1 [regex2] [...]

# Announce what this script does so the user knows what's going on
echo "hdupes script - delete duplicates that don't match specified patterns"

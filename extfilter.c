...
{
#ifndef NO_HELPTEXT
  printf("Detailed help for hdupes -X/--ext-filter options\n");
  printf("General format: hdupes -X filter[:value][size_suffix]\n\n");
...
/*  printf("\t\n"); */
  ...
  printf(  "Filters have cumulative effects: hdupes -X size+:99 -X size-:101 will\n");

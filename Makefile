...
# MAN_DIR indicates directory where the hdupes man page is to be
...
# Main object files
OBJS += hashdb.o
OBJS += args.o checks.o dumpflags.o extfilter.o filehash.o filestat.o hashpool.o hdupes.o helptext.o style.o
OBJS += interrupt.o libjodycode_check.o loaddir.o match.o pipeline.o progress.o sort.o travcheck.o
...
ifndef IGNORE_NEARBY_JC
 ifneq ("$(wildcard ../libjodycode/libjodycode.h)","")
  ...
  ifeq ("$(wildcard ../libjodycode/version.o)","")
   $(error You must build libjodycode before building hdupes)
  endif
 endif
...
distclean: clean
	$(RM) -rf *.pkg.tar* hdupes-*-*/ hdupes-*-*.zip
...
libjodycode_hint:
	$(info hint: if ../libjodycode is built but hdupes won't run, try doing 'make static_jc')
